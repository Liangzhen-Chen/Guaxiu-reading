...
export default function RegisterPage() {
  ...
  return (
    <div className="max-w-sm mx-auto mt-16">
      ...
      <input id="reg-password" className="w-full border-b border-border px-1 py-3 text-sm mb-4 placeholder:text-ink-soft focus-visible:ring-2 focus-visible:ring-stone-500 focus-visible:ring-offset-2" type="password" placeholder={t("password", lang)} value={pwd} onChange={e => setPwd(e.target.value)} aria-invalid={err ? "true" : undefined} aria-describedby={err ? "reg-error" : undefined} />
