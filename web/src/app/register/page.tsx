...
export default function RegisterPage() {
  ...
  return (
    <div className="max-w-sm mx-auto mt-16">
      ...
      <button onClick={submit} className="w-full rounded-full bg-[#1d1d1f] text-white py-3 text-sm font-medium hover:bg-black transition-colors mb-3">{t("register", lang)}</button>
