  ...
  return (
    <nav className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
      ...
      <div className="flex gap-5 text-sm text-[#86868b] items-center">
        {show && !nonAppPages.includes(p) && <a href="/books" className="hover:text-[#1d1d1f]">{t("bookshelf", lang)}</a>}
        {show && !nonAppPages.includes(p) && <a href="/wiki" className="hover:text-[#1d1d1f]">{t("wiki", lang)}</a>}
