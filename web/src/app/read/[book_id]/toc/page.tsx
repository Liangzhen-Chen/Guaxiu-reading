  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <p className="text-sm text-stone-400 mb-8">
        {progress.mode === "quick" ? "快速" : "深度"} · {total} 章 · {progress.status === "completed" ? "已读完" : `${Math.round(progress.progress_percent)}%`}
      </p>
      ...
      <div className="space-y-1">
        {Array.from({ length: total }, (_, i) => i + 1).map(ch => (
          ...
          >
            <span className="text-sm font-medium">{chapters[ch-1] || `第 ${ch} 章`}</span>
